...
type FileOptions struct {
	...
	JavaGenerateEqualsAndHash *bool `protobuf:"varint,20,opt,name=java_generate_equals_and_hash,json=javaGenerateEqualsAndHash" json:"javaGenerateEqualsAndHash,omitempty"` // Deprecated: Do not use.

...
import (
	fmt "fmt"
	github_com_frankee_protobuf_proto "github.com/frankee/protobuf/proto"
...
func extensionToGoStringDescriptor(m github_com_frankee_protobuf_proto.Message) string {
	e := github_com_frankee_protobuf_proto.GetUnsafeExtensionsMap(m)
	if e == nil {
		return "nil"
	}

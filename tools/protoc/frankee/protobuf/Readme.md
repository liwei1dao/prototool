...
[![GoDoc](https://godoc.org/github.com/frankee/protobuf?status.svg)](http://godoc.org/github.com/frankee/protobuf)
...
To use proto files from "google/protobuf" you need to add additional args to protoc.
    ...
    protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/frankee/protobuf/protobuf --{binary}_out=\
...
See [https://github.com/frankee/grpc-example](https://github.com/frankee/grpc-example) for an example of using gRPC with gogoprotobuf and the wider grpc-ecosystem.
